...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(addIntent, REQUEST_TAMBAH);
            }
        });
        ...
        ItemTouchHelper helper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (direction == ItemTouchHelper.LEFT) {
                    ...
                    startActivity(editIntent, REQUEST_EDIT);
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            startActivity(settingIntent, SETTING_REQUEST);
            return true;
    ...
    class AsyncTambahMahasiswa extends AsyncTask<Mahasiswa, Void, String> {
        ...
        protected String doInBackground(Mahasiswa... mahasiswas) {
            mhs = mahasiswas[0];
            String urlParameters = "nim=" + mhs.getNim() + "&" + "nama=" + mhs.getNama() + "&" + "email=" + mhs.getEmail() + "&" + "nomorHp=" + mhs.getNomorhp();
